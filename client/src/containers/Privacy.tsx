    ...
    <>
      <section className="basic-container privacy-container" id="privacy">
        <div className="privacy-text">
          ...
          <p>b.「통신비밀보호법」 제15조의2에 따른 통신사실확인자료 보관</p>
          <p>
          ...
          <p>제6조(이용자 및 법정대리인의 권리·의무 및 행사방법)</p>
          <p>
          ...
          <p>제7조(개인정보 자동 수집 장치의 설치·운영 및 거부)</p>
          <p>
          ...
          <p>성명 : 서동훈</p>
          <p>직책 : 전무이사</p>
          <p>연락처 : 02-3665-8611, , 02-3665-8615</p>
          <p>▶ 개인정보 보호 담당부서</p>
          <p>부서명 : 관리부</p>
          담당자 : 양민우
          <p>연락처 : 02-3665-8611, 02-3665-8615</p>
          ...
          <p>▶ 대검찰청 사이버범죄수사단 : 02-3480-3573</p>
